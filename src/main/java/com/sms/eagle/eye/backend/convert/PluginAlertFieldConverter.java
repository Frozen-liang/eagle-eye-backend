...
public interface PluginAlertFieldConverter {
    ...
    PluginAlertRuleWithValueResponse toResponse(PluginAlertFieldEntity pluginAlertFieldEntity);

    default Integer map(FieldType value) {
        return Objects.nonNull(value) ? value.getNumber() : FieldType.FIELD_UNKNOWN_VALUE;
    }

    PluginAlertRuleWithValueResponse toValueResponse(PluginAlertFieldEntity pluginConfigFieldEntity, Object value);
}