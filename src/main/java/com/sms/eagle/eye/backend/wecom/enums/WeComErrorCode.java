...
public enum WeComErrorCode {
    ...
    private static final Map<String, WeComErrorCode> MAP;

    static {
        MAP = Arrays.stream(values()).collect(Collectors.toMap(WeComErrorCode::getErrorCode, Function.identity()));
    }

    private final String errorCode;
    private final String errorDesc;

    WeComErrorCode(String errorCode, String errorDesc) {
        this.errorCode = errorCode;
        this.errorDesc = errorDesc;
    }

    public static String getErrorDesc(String errorCode) {
        return Optional.ofNullable(MAP.get(errorCode)).map(WeComErrorCode::getErrorDesc).orElse(null);
    }

    public static WeComErrorCode errorCode(String code) {
