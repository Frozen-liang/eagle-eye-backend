...
public class AuthInterceptorTest {
    ...
    UserPermissionGroupService userPermissionGroupService = mock(UserPermissionGroupService.class);
    AuthInterceptor authInterceptor = spy(new AuthInterceptor(userPermissionGroupService));
    ...
    void preHandle_test() {
        ...
        when(userPermissionGroupService.getPermissionByEmail(any()))
